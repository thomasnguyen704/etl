		...
		<form method="POST" action="/req/edit">
			...
			<div class="small">
				...
				<div class="col-sm-3">
					...
					<input type="text" class="form-control input-sm datepicker" id="start" name="start" placeholder="Start Date" value="{{ $request->start }}"><br>
				...
				<div class="col-sm-3">
					...
					<input type="text" class="form-control input-sm datepicker" id="end" name="end" placeholder="Close Date" value="{{ $request->end }}"><br>
